...
Contributors: Will Anderson, Tony Ferrell 
...
# Upload the WP SendGrid to the /wp-contents/plugins/ folder.
# Activate the plugin from the 'Plugins' menu in WordPress.
# Configure WP SendGrid with your SendGrid API credentials. 
